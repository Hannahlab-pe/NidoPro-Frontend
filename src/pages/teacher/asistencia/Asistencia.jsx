...
const Asistencia = () => {
  ...
  const estadisticas = {
    ...
    ausentes: Object.values(asistencias).filter((a) => a?.estado === "ausente")
      .length,
    ...
    pendientes: Object.values(asistencias).filter((a) => a?.estado === "")
      .length,
  };
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Controles - sin fondo de tarjeta */}
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <input
                            ...
                            className="px-3 py-1 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 w-40"
                          />
                        </div>
                        ...
                        {asistenciaActual.estado && (
                          <div
                            className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium border ${getEstadoColor(asistenciaActual.estado)}`}
                          >
